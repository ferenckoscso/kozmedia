  ...
  return (
    <section ref={sectionRef} className="relative py-24 md:py-32 section-padding">
      <div className="max-w-5xl mx-auto">
        <div className="mb-4">
          <span className="text-xs tracking-[0.3em] uppercase text-gold">Mesterséges intelligencia</span>
        </div>

        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-balance max-w-4xl">
          Ne tiltsuk — szabályozzuk.
        </h2>

        <p className="text-lg text-muted-foreground mb-16 max-w-2xl">
          A háromsávos AI-felhasználási keretrendszer. A zöldek alkalmazhatók, a sárgák ellenőrzéssel, a pirosak soha.
        </p>
            ...
            >
              ...
              >
                ...
                <div className="mt-4 text-xs text-muted-foreground uppercase tracking-wider">
                  {activeZone === index ? 'Kattints a becsukáshoz' : 'Kattints a részletekért'}
                </div>
              </div>
            </div>
          ))}
