...
const content = {
  hu: {
    ...
    titleGold: 'álmodni',
    body: 'A jövőálló közmédia nem egy önmagában létező, mindenható entitás, hanem egy közszolgáltatást végző szervezet, amely akkor teljesíti küldetését, ha a tevékenysége az egész társadalom számára hasznos és értékes.',
  ...
  en: {
    ...
    titleGold: 'big',
    body: "Future-proof public media isn't an all-powerful entity that exists on its own: it's a public-service organisation that fulfils its mission when its work is useful and valuable to society as a whole.",
